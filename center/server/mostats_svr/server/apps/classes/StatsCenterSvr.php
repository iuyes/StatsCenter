...
class StatsCenterSvr
{
    ...
    {
//        if ($from_worker_id == $this->setting['task_worker_num']+$this->setting['worker_num']-1 )
//        {
//            $map = json_decode($data,1);
//            $this->log("insert task".var_export($map,1));
//            if ($map)
//            {
//                $this->insertToDB($map,self::T_ALL);
//                $this->insertToDB($map,self::T_SERVER);
//                $this->insertToDB($map,self::T_CLIENT);
//            }
//            else
//            {
//                $this->log("insert mysql data error".var_export($data,1));
//            }
//        }
//        else
//        {
